...
func conversionTests() []conversionTest {
	...
	return []conversionTest{
		...
		{s: "1.5", d: new(userDefined), wantusrdef: 1.5},
		{s: []byte{1, 2, 3}, d: new(userDefinedSlice), wanterr: `unsupported Scan, storing driver.Value type []uint8 into type *dbq.userDefinedSlice`},
...
func TestNullString(t *testing.T) {
	...
	if ns.Val != "" {
		t.Errorf("expecting blank on nil; got %q", ns.Val)
	}
}
...
var valueConverterTests = []valueConverterTest{
	{driver.DefaultParameterConverter, Null[string]{"hi", true}, "hi", ""},
	{driver.DefaultParameterConverter, Null[string]{"", false}, nil, ""},
}
